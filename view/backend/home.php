			...
			<div class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
			    ...
			    <div class="collapse navbar-collapse" id="menu">
					<ul class="nav navbar-nav nav-hover mr-auto">
								<li class="nav-item"><a class="nav-link text-white" href="admin.php?controller=user&name=<?php echo $_SESSION["username"];?>">Xin chào: <span style="color: yellow;font-size: 18px;"><?php echo $_SESSION["username"]; ?></span> </a></li>
